...
The Kueue Addon for Red Hat Advanced Cluster Management (ACM) allows a user to enable RHBoK on their managed clusters, simplifies MultiKueue setup and enhances multicluster batch job scheduling capabilities across OpenShift clusters.
...
**Repository**: [open-cluster-management-io/addon-contrib/kueue-addon](https://github.com/open-cluster-management-io/addon-contrib/tree/main/kueue-addon)

### Installation

For detailed installation instructions, see the [Kueue Addon Installation Guide for ACM](https://github.com/stolostron/foundation-docs/blob/main/guide/ManagedCluster/KueueAddonInstallation.md).
